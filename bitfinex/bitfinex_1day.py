...
def initialize(context):
    ...
    context.trading_pairs = ["btc_usd"]
    #context.allocation = (0.7 / 9)
    context.allocation = 0.33
    atr_length = 12
    atr_multiplier = 4
    ...
    asset = CryptoAsset(symbol('btc_usd'), dip_levels, atr_multiplier, atr_length, 0.33)

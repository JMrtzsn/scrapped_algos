...
def initialize(context):
    log.info('Initializing ANN Algorithm')
    ...
    context.longCandle = '1d'
    context.shortCandle = '60T'
    context.threshold = 0.0014
...
def PineActivationFunctionLinear(v):
    return v
...
def ANN(inp):
    l0_0 = PineActivationFunctionLinear(inp)
    l0_1 = PineActivationFunctionLinear(inp)
    l0_2 = PineActivationFunctionLinear(inp)
    l0_3 = PineActivationFunctionLinear(inp)
    l0_4 = PineActivationFunctionLinear(inp)
    l0_5 = PineActivationFunctionLinear(inp)
    l0_6 = PineActivationFunctionLinear(inp)
    l0_7 = PineActivationFunctionLinear(inp)
    l0_8 = PineActivationFunctionLinear(inp)
    l0_9 = PineActivationFunctionLinear(inp)
    l0_10 = PineActivationFunctionLinear(inp)
    l0_11 = PineActivationFunctionLinear(inp)
    l0_12 = PineActivationFunctionLinear(inp)
    l0_13 = PineActivationFunctionLinear(inp)
    l0_14 = PineActivationFunctionLinear(inp)

    l1_0 = PineActivationFunctionTanh(
    ...
    l1_1 = PineActivationFunctionTanh(
    ...
    l1_3 = PineActivationFunctionTanh(
    ...
    l1_4 = PineActivationFunctionTanh(
    ...
    l1_5 = PineActivationFunctionTanh(
    ...
    l1_6 = PineActivationFunctionTanh(
    ...
    l1_7 = PineActivationFunctionTanh(
    ...
    l1_9 = PineActivationFunctionTanh(
    ...
    l1_10 = PineActivationFunctionTanh(
    ...
    l1_12 = PineActivationFunctionTanh(
    ...
    l1_13 = PineActivationFunctionTanh(
    ...
    l1_14 = PineActivationFunctionTanh(
    ...
    l1_15 = PineActivationFunctionTanh(
    ...
    l1_16 = PineActivationFunctionTanh(
    ...
    l1_18 = PineActivationFunctionTanh(
    ...
    l1_20 = PineActivationFunctionTanh(
    ...
    l1_21 = PineActivationFunctionTanh(
    ...
    l1_23 = PineActivationFunctionTanh(
    ...
    l1_25 = PineActivationFunctionTanh(
    ...
    l1_26 = PineActivationFunctionTanh(
    ...
    l1_27 = PineActivationFunctionTanh(
    ...
    l1_28 = PineActivationFunctionTanh(
    ...
    l1_29 = PineActivationFunctionTanh(
    ...
    l2_0 = PineActivationFunctionTanh(
    ...
    l2_1 = PineActivationFunctionTanh(
    ...
    l2_2 = PineActivationFunctionTanh(
    ...
    l2_4 = PineActivationFunctionTanh(
    ...
    l2_5 = PineActivationFunctionTanh(
    ...
    l2_6 = PineActivationFunctionTanh(
    ...
    l2_7 = PineActivationFunctionTanh(
    ...
    l2_8 = PineActivationFunctionTanh(
    ...
    l3_0 = PineActivationFunctionTanh(
...
def _handle_data(context, data):
    ...
    histl = data.history(
        ...
        bar_count=365,
        frequency=context.longCandle
    )
    hist2 = data.history(
        context.asset,
        fields=['open', 'high', 'low', 'price'],
        bar_count=365,
        frequency=context.shortCandle
    )

    entryYesterday = ((histl.open[-2] + histl.high[-2] + histl.low[-2] + histl.close[-2]) / 4)
    entryToday = ((histl.open[-1] + histl.high[-1] + histl.low[-1] + histl.close[-1]) / 4)
    entry = (entryToday-entryYesterday)/entryYesterday

    exitYesterday = ((hist2.open[-2] + hist2.high[-2] + hist2.low[-2] + hist2.close[-2]) / 4)
    exitToday = ((hist2.open[-1] + hist2.high[-1] + hist2.low[-1] + hist2.close[-1]) / 4)
    exit = (exitToday - exitYesterday) / exitYesterday

    exitPrediction = ANN(exit)
    entryPrediction = ANN(entry)
    goLong = entryPrediction < -context.threshold and exitPrediction < -context.threshold
    goShort = entryPrediction > context.threshold and exitPrediction > context.threshold

    closeLong = (exitPrediction >= context.threshold or entryPrediction >= context.threshold)
    closeShort = (exitPrediction <= -context.threshold or entryPrediction <= context.threshold)

    if closeLong and context.in_long:
        order_target_percent(context.asset, 0)
        context.in_long = False
        log.info('{now}: -\t closed long at C{c},'.format(now=now, c=hist2.close[-1]))
    if closeShort and context.in_short:
        order_target_percent(context.asset, 0)
        context.in_short = False
        log.info('{now}: -\t closed short at C{c},'.format(now=now, c=hist2.close[-1]))
    if goLong and not context.in_long:
        order_target_percent(context.asset, 1)
        context.in_long = True
        context.in_short = False
        log.info('{now}: -\t bought at C{c},'.format(now=now, c=hist2.close[-1]))
    if goShort and not context.in_short:
        order_target_percent(context.asset, -1)
        context.in_short = True
        context.in_long = False
        log.info('{now}: -\t sold at C{c},'.format(now=now, c=hist2.close[-1]))

...
def initialize(context):
    ...
    context.trading_pairs = ["btc_usdt", "eth_usdt", "ltc_usdt", "eos_usdt", "xrp_usdt",
                             "iota_usdt", "bch_usdt", "trx_usdt", "xlm_usdt", 'ada_usdt']
    ...
    asset = CryptoAsset(symbol('btc_usdt'), dip_levels, 2, 12, context.allocation)
...
def load_history_and_indicators(context, data, asset):
    try:
        ...
        #if context.btc_long or asset.uptrend or context.assets[0].symbol == asset.symbol:
...
class CryptoAsset(object):
    def __init__(self, symbol, dip_level, atr_multiplier, atr_length, portfolio_allocation):
        ...
        self.vstop_is_uptrend_prev = False
